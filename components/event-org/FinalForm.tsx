            ...
            <div className="grid gap-6 mt-4">
              <div className="flex gap-6 flex-wrap w-full">
                <div className="flex-[1_1_250px] relative min-w-62.5">
                  ...
                  <input
                    ...
                    className={`w-full px-4 py-3 border rounded text-sm outline-none text-gray-800 bg-white box-border ${formErrors["contactInfo.mobile"] ? "border-red-400" : "border-gray-400"}`}
                ...
                <div className="flex-[1_1_250px] relative min-w-62.5">
                  ...
                  <input
                    ...
                    className={`w-full px-4 py-3 border rounded text-sm outline-none text-gray-800 bg-white box-border ${formErrors["contactInfo.email"] ? "border-red-400" : "border-gray-400"}`}
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full px-4 py-3 border border-gray-400 rounded text-sm outline-none text-gray-800 bg-white box-border"
        ...
        {openSections.postEvent ? (
          <div className="px-8 pb-8 max-[768px]:px-4 max-[768px]:pb-4">
            <div className="mt-4 relative">
              ...
              <textarea
                className={`w-full h-30 px-4 py-3 border rounded text-sm outline-none resize-y text-gray-800 bg-white box-border ${formErrors["postEventFollowUp.thankYouNote"] ? "border-red-400" : "border-gray-400"}`}
