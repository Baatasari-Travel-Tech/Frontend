        ...
        <div className="mx-auto w-full max-w-[1680px] px-4 py-10 sm:px-6 md:px-10 lg:px-16">
          <div className="grid grid-cols-1 gap-x-6 gap-y-8 md:grid-cols-[2fr_1fr_1fr_1fr]">
            <div className="md:col-span-1">
              <Image src="/FLogo.png" alt="Baatasari" width={132} height={48} className="h-10 w-auto" />
            </div>
            ...
            <div className="max-w-sm text-sm text-slate-300">
              Discover, connect, experience. Official platform for curated events, venues, and
              experiences.
            </div>
            ...
            <div className="space-y-3 text-sm">
              ...
              <div className="grid gap-2 text-slate-300">
                <a className="transition hover:text-white" href="/terms&conditions">Terms & Conditions</a>
                <a className="transition hover:text-white" href="/privacy-policy">Privacy Policy</a>
                <a className="transition hover:text-white" href="/refund-policy">Refund & Cancellation</a>
                <a className="transition hover:text-white" href="/grievance">Grievance Redressal</a>
              </div>
            </div>
